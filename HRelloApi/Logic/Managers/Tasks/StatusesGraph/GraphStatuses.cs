...
public static class StatusesGraph
{
    ...
    {
        { ActionTypeEnum.None, ActionTypeEnum.OnChecking, ActionTypeEnum.OnRework, ActionTypeEnum.OnWork, ActionTypeEnum.None, ActionTypeEnum.None, ActionTypeEnum.None },
