...
public static class StatusesGraph
{
    ...
    {
        { ActionTypeEnum.OnChecking, ActionTypeEnum.OnRework, ActionTypeEnum.OnWork, ActionTypeEnum.None, ActionTypeEnum.None, ActionTypeEnum.None, ActionTypeEnum.Cancellation },
